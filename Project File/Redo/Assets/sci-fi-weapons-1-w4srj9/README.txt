This is the README for Sci-Fi Weapons - 3 Variations.
You can purchase the other versions of this pack from Dev Assets.

-- INSTRUCTIONS --

If you are using Unity and want to get up an running right away you can open the "Sci-Fi Weapons (3 Variations).unitypackage" which also comes with an Example Scene.
...
The folder "3 Variations" then contains 2 extra sets of variation textures for each weapon.
